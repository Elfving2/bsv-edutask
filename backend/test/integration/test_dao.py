...
def test_create_valid_user(dbConnection, data):
    ...
    assert '_id' in result # will be generated by MongoDB, so we cannot predict its value, but we can check that it exists
...
@pytest.mark.parametrize("data", [
    ...
    {"firstName": "Tuva"},  # missing email and lastName
